...
* Sequence modeling: Intro ([YouTube](https://youtu.be/2MYjsAijxSw))
* Sequence modeling: Probability review ([YouTube](https://youtu.be/Yj6owCbkWLM))
* Sequence modeling: Markov assumption ([YouTube](https://youtu.be/xIRWEfOVOGE))
* Sequence modeling: Markov chains, part 1 ([YouTube](https://youtu.be/H2amPLKnC6g))
* Sequence modeling: Markov chains, part 2 ([YouTube](https://youtu.be/ZVwym-ZWfMI))
* Sequence modeling: Hidden Markov Models, part 1 ([YouTube](https://youtu.be/qOcHydNqwX0))
* Sequence models: HMM decoding ([YouTube](https://youtu.be/4EYpVDFcVsA))
* Sequence modeling: Applying HMMs to CpG island finding ([YouTube](https://youtu.be/xi9c7J-E2C0))
* Sequence modeling: HMMs for gene finding, part 1 ([YouTube](https://youtu.be/FlPRgtggE7M))
* Sequence modeling: HMMs for gene finding, part 2 ([YouTube](https://youtu.be/AhFlSFTSWAs))
