...
* Sequence modeling: Intro ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_00_intro.pdf), [YouTube](https://youtu.be/2MYjsAijxSw))
* Sequence modeling: Probability review ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_02_probreview.pdf), [YouTube](https://youtu.be/Yj6owCbkWLM))
* Sequence modeling: Markov assumption ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_03_markovassum.pdf), [YouTube](https://youtu.be/xIRWEfOVOGE))
* Sequence modeling: Markov chains, part 1 ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_05_chains.pdf), [YouTube](https://youtu.be/H2amPLKnC6g))
* Sequence modeling: Markov chains, part 2 ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_07_chains2.pdf), [YouTube](https://youtu.be/ZVwym-ZWfMI))
* Sequence modeling: Hidden Markov Models, part 1 ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_10_hmm1.pdf), [YouTube](https://youtu.be/qOcHydNqwX0))
* Sequence models: HMM decoding ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_15_decoding.pdf), [YouTube](https://youtu.be/4EYpVDFcVsA))
* Sequence modeling: Applying HMMs to CpG island finding ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_20_cpgisland.pdf), [YouTube](https://youtu.be/xi9c7J-E2C0))
* Sequence modeling: HMMs for gene finding, part 1 ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_30_genefind1.pdf), [YouTube](https://youtu.be/FlPRgtggE7M))
* Sequence modeling: HMMs for gene finding, part 2 ([Slides](http://www.cs.jhu.edu/~langmea/resources/lecture_notes/seqmod/mod_35_genefind2.pdf), [YouTube](https://youtu.be/AhFlSFTSWAs))
