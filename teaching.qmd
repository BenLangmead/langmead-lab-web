...
* [Lecture videos](https://youtube.com/playlist?list=PL2mpR0RYFQsADmYpW2YWBrXJZ_6EL_3nu) on YouTube (27 videos)
* Slides and per-lecture links: see the Burrows-Wheeler Indexing section in Lecture notes below

### Suffix Indexing

* [Lecture videos](https://youtube.com/playlist?list=PL2mpR0RYFQsDFNyRsTNcWkFTHTkxWREeb) on YouTube (15 videos)
* Slides and per-lecture links: see the Suffix Indexing section in Lecture notes below

### Sketching and Randomized Data Structures

* [Lecture videos](https://youtube.com/playlist?list=PL2mpR0RYFQsAR5RyB54FyEE9vUiGtCSZM) on YouTube (16 videos)
* Slides and per-lecture links: see the Sketching and Randomized Data Structures section in Lecture notes below

### Sequence Modeling

* [Lecture videos](https://www.youtube.com/playlist?list=PL2mpR0RYFQsAK40GHyupLV4M-3wH8EOup) on YouTube (10 videos)
* Slides and per-lecture links: see the Sequence Modeling section in Lecture notes below

## Lecture notes

Click a section title to expand.

::: {.callout-note collapse="true" appearance="minimal" title="Computational Genomics"}
...
::: {.callout-note collapse="true" appearance="minimal" title="Suffix Indexing"}
...
::: {.callout-note collapse="true" appearance="minimal" title="Burrows-Wheeler Indexing"}
...
::: {.callout-note collapse="true" appearance="minimal" title="Sketching and Randomized Data Structures"}
...
::: {.callout-note collapse="true" appearance="minimal" title="Sequence Modeling"}

*[YouTube playlist](https://www.youtube.com/playlist?list=PL2mpR0RYFQsAK40GHyupLV4M-3wH8EOup), 10 videos*
...
::: {.callout-note collapse="true" appearance="minimal" title="C and C++ Programming"}
